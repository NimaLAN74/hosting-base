...
/// Shared response cache type (used by comp_ai and controls handlers for AppState).
pub type ResponseCache = Option<std::sync::Arc<moka::sync::Cache<String, CachedResponse>>>;
